...
namespace hateekub.Migrations
{
    ...
    [Migration("20260302144739_FixRoomSetting")]
    partial class FixRoomSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hateekub.Models.GameRank", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/iron.png",
                            RankName = "Iron"
                        },
                        new
                        {
                            Id = 2,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/bronze.png",
                            RankName = "Bronze"
                        },
                        new
                        {
                            Id = 3,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/silver.png",
                            RankName = "Silver"
                        },
                        new
                        {
                            Id = 4,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/gold.png",
                            RankName = "Gold"
                        },
                        new
                        {
                            Id = 5,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/plat.png",
                            RankName = "Platinum"
                        },
                        new
                        {
                            Id = 6,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/diamond.png",
                            RankName = "Diamond"
                        },
                        new
                        {
                            Id = 7,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/immortal.png",
                            RankName = "Immortal"
                        },
                        new
                        {
                            Id = 8,
                            GameId = 2,
                            RankImageUrl = "/images/ranks/val/radiant.png",
                            RankName = "Radiant"
                        });
                });
