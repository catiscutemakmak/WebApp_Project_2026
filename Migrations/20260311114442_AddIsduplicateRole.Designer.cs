...
namespace hateekub.Migrations
{
    ...
    [Migration("20260311114442_AddIsduplicateRole")]
    partial class AddIsduplicateRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hateekub.Models.GameRank", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 10,
                            GameId = 5,
                            RankImageUrl = "/images/ranks/mlbb/Warrior.webp",
                            RankName = "Warrior"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("hateekub.Models.Notification", b =>
                {
                    b.HasOne("hateekub.Models.UserProfile", "ActorUser")
                        .WithMany()
